...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SANCTIONLIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_SANCTIONLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SANCTIONLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SANCTIONLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SANCTIONLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SANCTIONLIST actions', async () => {
      const expectedActions = [
        {
